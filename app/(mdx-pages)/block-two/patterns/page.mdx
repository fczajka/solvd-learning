...
- Creational Design Pattern - For handling Object creation mechanisms
  ...
  - Singleton
  - Builder
- Structural Design Pattern - For identifying ways to realize relationships between objects
  - Adapter
  - Bridge
  - Composite
  - Decorator
  ...
  - Flyweight
  - Proxy
- Behavioral Design Pattern - For handling communication between different objects
